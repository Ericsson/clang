...
// CHECK-NEXT:      <string>Expanding macro &apos;mallocmemory&apos; to &apos;int *x = (int*)malloc(12);&apos;</string>
...
// CHECK-NEXT:      <key>depth</key><integer>0</integer>
// CHECK-NEXT:      <key>extended_message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;checkmacro&apos; to &apos;p==0&apos;</string>
// CHECK-NEXT:      <key>message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;checkmacro&apos; to &apos;p==0&apos;</string>
// CHECK-NEXT:     </dict>
// CHECK-NEXT:     <dict>
...
// CHECK-NEXT:      <key>depth</key><integer>0</integer>
// CHECK-NEXT:      <key>extended_message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;macroWithArg&apos; to &apos;mp==0&apos;</string>
// CHECK-NEXT:      <key>message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;macroWithArg&apos; to &apos;mp==0&apos;</string>
// CHECK-NEXT:     </dict>
// CHECK-NEXT:     <dict>
...
// CHECK-NEXT:      <key>depth</key><integer>0</integer>
// CHECK-NEXT:      <key>extended_message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;multiNoteMacroWithError&apos; to &apos;if (p) ; *p = 5;&apos;</string>
// CHECK-NEXT:      <key>message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;multiNoteMacroWithError&apos; to &apos;if (p) ; *p = 5;&apos;</string>
// CHECK-NEXT:     </dict>
// CHECK-NEXT:     <dict>
...
// CHECK-NEXT:      <key>depth</key><integer>0</integer>
// CHECK-NEXT:      <key>extended_message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;multiNoteMacro&apos; to &apos;if (p) ;if (y) ;&apos;</string>
// CHECK-NEXT:      <key>message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;multiNoteMacro&apos; to &apos;if (p) ;if (y) ;&apos;</string>
// CHECK-NEXT:     </dict>
// CHECK-NEXT:     <dict>
...
// CHECK-NEXT:      <key>depth</key><integer>0</integer>
// CHECK-NEXT:      <key>extended_message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;CALL_FN&apos; to &apos;null_deref(a)&apos;</string>
// CHECK-NEXT:      <key>message</key>
// CHECK-NEXT:      <string>Expanding macro &apos;CALL_FN&apos; to &apos;null_deref(a)&apos;</string>
// CHECK-NEXT:     </dict>
// CHECK-NEXT:     <dict>
...
// CHECK-NEXT:      <key>depth</key><integer>0</integer>
// CHECK-NEXT:      <key>extended_message</key>
// CHECK-NEXT:      <string>Passing value via 1st parameter &apos;a&apos;</string>
// CHECK-NEXT:      <key>message</key>
// CHECK-NEXT:      <string>Passing value via 1st parameter &apos;a&apos;</string>
// CHECK-NEXT:     </dict>
// CHECK-NEXT:     <dict>
